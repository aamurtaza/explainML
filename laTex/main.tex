...
\section{Experiments and Results}\label{sec:experiments} %\section{Four}
...
\begin{figure}[H]
	\vspace*{0mm}
	\centering
	\subfloat[Random Forest, LIME]{{\includegraphics[width=5cm,height=3.5cm]{lime_rf_iris_instance_interpret.png} }}%
	\qquad
	\subfloat[Logistic Regression, LIME]{{\includegraphics[width=5cm,height=3.5cm]{lime_lr_iris_instance_interpret.png} }}%
...
\begin{figure}[H]
	\vspace*{-5mm}
	\centering
	\subfloat[SHAP (L=0.20)]{{\includegraphics[width=5cm,height=5cm]{iris_rf_deviation_stability_shap.png} }}%
	\qquad
	\subfloat[LIME (L=2.80)]{{\includegraphics[width=5cm,height=5cm]{iris_rf_deviation_stability_lime.png} }}%
...
\begin{figure}[H]
	\vspace*{-5mm}
	\centering
	\subfloat[SHAP (L=0.157)]{{\includegraphics[width=5cm,height=5cm]{iris_lr_deviation_stability_shap.png} }}%
	\qquad
	\subfloat[LIME (L=2.03)]{{\includegraphics[width=5cm,height=5cm]{iris_lr_deviation_stability_lime.png} }}%
	\caption{{LIME and SHAP explanations deviation examples on interpreting \textbf{\textit{Logistic Regression}} model: \textbf{Top}: example $x_i$ from the \textit{iris} dataset and its explanations (attributions). \textbf{Bottom}: explanations for the maximizer of the Lipschitz estimate $L(x_i)$ as per \eqref{eq:lipschitz_estimation}.}}%

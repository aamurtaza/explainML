...
%Important Points
%Explaining several representative instances.
%Selecting the trustworthy model using explanations

%Outline evaluation characteristics
%	Interpretability of explanations -- understanable
%	Local fidelity -- faithfulness
%	Global perspective -- selecting few explanations as representative of model
...
%$\{0, 1\}^{d'}$ is a binary vector for interpretable representation. \newline

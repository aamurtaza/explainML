...
\begin{figure}[H]
	\vspace*{0mm}
	\centering
	\subfloat[Random Forest, LIME]{{\includegraphics[width=5cm,height=3.5cm]{lime_rf_iris_instance_interpret.png} }}\label{subfig:lime_rf_iris_instance_interpretations}
	\qquad
	\subfloat[Logistic Regression, LIME]{{\includegraphics[width=5cm,height=3.5cm]{lime_lr_iris_instance_interpret.png} }}\label{subfig:lime_lr_iris_instance_interpretations}
...
\begin{figure}[H]
	\vspace*{0mm}
	\centering
	\subfloat[Random Forest, SHAP]{{\includegraphics[width=5cm,height=3.5cm]{shap_rf_iris_summary_plot.png} }}%
	\qquad
	\subfloat[Logistic Regression, SHAP]{{\includegraphics[width=5cm,height=3.5cm]{shap_lr_iris_summary_plot.png} }}%
...
%\begin{figure}
%	\centering
%	\subfigure[Check SHAP (L=0.20)]{
%		\includegraphics[width=0.4\linewidth ,height=7cm]{iris_rf_deviation_stability_shap.png}%
%	}
%	\subfigure[LIME (L=2.80)]{
%		\includegraphics[width=0.4\linewidth ,height=7cm]{iris_rf_deviation_stability_lime.png}%
%	}
%\end{figure}
...
%	\vspace*{0mm}
%	\centering
	\subfloat[SHAP (L=0.20)]{{\includegraphics[width=0.49\linewidth ,height=7cm]{iris_rf_deviation_stability_shap.png}}}%
	\hspace*{\fill}%
	\subfloat[LIME (L=2.80)]{{\includegraphics[width=0.49\linewidth ,height=7cm]{iris_rf_deviation_stability_lime.png} }}%
...
\begin{figure}[htp]
	%	\vspace*{0mm}
	%	\centering
	\subfloat[SHAP (L=0.157)]{{\includegraphics[width=0.49\linewidth ,height=7cm]{iris_lr_deviation_stability_shap.png}}}%
	\hspace*{\fill}%
	\subfloat[LIME (L=2.03)]{{\includegraphics[width=0.49\linewidth ,height=7cm]{iris_lr_deviation_stability_lime.png} }}%
...
\begin{figure}[H]
	\vspace*{-5mm}
	\centering
	\subfloat[Saliency]{{\includegraphics[width=3cm]{noise_digit_3_deviation_Saliency.png} }}%
	\qquad
	\subfloat[Grad*input]{{\includegraphics[width=3cm]{noise_digit_3_deviation_Grad*input.png} }}%
	\qquad
	\subfloat[e-LRP]{{\includegraphics[width=3cm]{noise_digit_3_deviation_e-LRP.png} }}%
	\qquad
	\subfloat[Occlusion]{{\includegraphics[width=3cm]{noise_digit_3_deviation_Occlusion.png} }}%
	\qquad
	\subfloat[Deeplift]{{\includegraphics[width=3cm]{noise_digit_3_deviation_Deeplift.png} }}%
...
\begin{figure}[H]
	\vspace*{-5mm}
	\centering
	\subfloat[Saliency]{{\includegraphics[width=3cm]{digit_3_deviation_Saliency.png} }}%
	\qquad
	\subfloat[Grad*input]{{\includegraphics[width=3cm]{digit_3_deviation_Grad*input.png} }}%
	\qquad
	\subfloat[e-LRP]{{\includegraphics[width=3cm]{digit_3_deviation_e-LRP.png} }}%
	\qquad
	\subfloat[Occlusion]{{\includegraphics[width=3cm]{digit_3_deviation_Occlusion.png} }}%
	\qquad
	\subfloat[Deeplift]{{\includegraphics[width=3cm]{digit_3_deviation_Deeplift.png} }}%
	\caption{Figures side by side}%
